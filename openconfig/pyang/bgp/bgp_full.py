...
eos_bgp = {'ceos1': {'AS': '65001', 'PEER_AS': '65002', 'ROUTER_ID': '1.1.1.1', 'PEER': '10.12.0.2'}, 'ceos2': {'AS': '65002', 'PEER_AS': '65001', 'ROUTER_ID': '2.2.2.2', 'PEER': '10.12.0.1'}}

def main():
  for k,v in eos_bgp.items():
    ...
    print(k, struct)
    with open("../../../flask/static/"+k+'.json', 'w') as f:
      f.write(struct)
